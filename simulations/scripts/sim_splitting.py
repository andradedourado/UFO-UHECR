...
def simulation():
	...
	output1 = crpropa.TextOutput(f'{RESULTS_DIR}/shock_upstream_splitting.txt', crpropa.Output.Event3D)
	...
	output2 = crpropa.TextOutput(f'{RESULTS_DIR}/shock_downstream_splitting.txt', crpropa.Output.Event3D)
